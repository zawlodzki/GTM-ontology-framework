...
Sales cycle 4–8 weeks. ~25 new deals/month enter the pipeline.

## ICP
Mid-market e-commerce (50–500 employees, EU, >EUR 5M online revenue). Buyer: Head of
E-commerce or CMO. Disqualifiers: marketplaces-only sellers, <EUR 1M revenue, agencies.

## GTM Motion
~60% inbound (content + product demo requests), ~40% outbound (SDR sequences).
...
2. Qualify leads from call transcripts (draft AI qualification, propose stage moves).
3. Keep CRM hygiene: missing required fields, stale deals, SLA breaches.
4. Prepare weekly pipeline review summary for Head of Sales.
