...
- Everything included in Growth, with multi-market and multi-currency analysis.
- Role-based access, team workspaces, change history, and definition ownership.
- Governed warehouse export for modeled analytics data.
- Up to 40 named users and 12 scheduled report deliveries.
- Named Customer Success owner and quarterly adoption review.
