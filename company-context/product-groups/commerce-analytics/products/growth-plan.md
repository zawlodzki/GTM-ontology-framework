...
- Standard order, customer, product, cohort, refund, and repeat-purchase models.
- Up to 10 named users and three scheduled report deliveries.
- Currency normalization for one reporting currency.
- CSV export and documented metric definitions.
- Standard remote onboarding and two metric-validation workshops.
