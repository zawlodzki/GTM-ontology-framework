...
4. A fit prompt asks about the production warehouse, use case, destination, and owners.
...
1. Revenue confirms `icp:data-activation-icp` and the named business use case.
